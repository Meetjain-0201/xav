...
interface Props { data: TransparencyEntry[] }
...
export default function StiasBar({ data }: Props) {
    ...
    <ResponsiveContainer width="100%" height={260}>
      <BarChart data={chartData} margin={{ top: 10, right: 20, left: 10, bottom: 10 }} barSize={52}>
        ...
        <YAxis
          ...
          label={{ value: 'Transparency (1–7)', angle: -90, position: 'insideLeft', offset: -5, style: { fontSize: 11, fill: '#94a3b8' } }}
        />
